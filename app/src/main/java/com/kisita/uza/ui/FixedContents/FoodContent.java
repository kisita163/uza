...
public class FoodContent {
    ...
    private static final String [] methods = {"Meat, Fish & Eggs","Dairy products","Fat","Vegetables and fruits","Cereals & Derivatives","Drinks","Sweet products"};

    private static final int [] icons = {R.drawable.meat,R.drawable.dairy ,R.drawable.mobile_money, R.drawable.fruits,R.drawable.cereals,R.drawable.drinks,R.drawable.sweet};
    /**
